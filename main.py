...
label = tk.Label(root, textvariable=label_text, font=('Arial', 30), bg='white', width=22, height=2)
...
button = tk.Button(root, text='=', command=evaluate, font=('Arial', 30), width=16, height=2)
